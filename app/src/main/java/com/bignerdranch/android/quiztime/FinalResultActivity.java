...
public class FinalResultActivity extends AppCompatActivity {
    ...
    public static Intent newIntentL2(Context cont,int resultScore){
        Intent i = new Intent(cont,FinalResultActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAnswerDisplay= (TextView) findViewById(R.id.l2score);
